...
<body>
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
            <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">Problem & Support</h2>
            <p class="mt-1 text-gray-600 dark:text-gray-400">See if your tenants are facing any problem and provide them support.</p>
        </div>
        <!-- End Title -->
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <!-- Card -->
            <router-link to="/problem-dashboard-owner" class="group hover:bg-gray-100 rounded-xl p-5 transition-all dark:hover:bg-white/[.05]" >
                <div class="aspect-w-16 aspect-h-10">
                ...
                <h3 class="mt-5 text-2xl font-bold text-gray-800 dark:text-gray-300 dark:group-hover:text-white">
                    Problems that your tenants are facing.
                </h3>
                <p class="mt-3 inline-flex items-center gap-x-2 text-sm font-semibold text-gray-800 dark:text-gray-200">
                    See all
                    <svg class="w-2.5 h-2.5 transition ease-in-out group-hover:translate-x-1" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
