    ...
    methods: {
        ...
        async update_owner() {
            if (this.current_password == this.update_owner_details.password) {
                ...
                let update_owner = await axios.put("https://shomadhan.top/admin/api/Api/Owner/Updated/" + this.id, {
